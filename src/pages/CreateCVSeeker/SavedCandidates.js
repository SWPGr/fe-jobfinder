          ...
          >
            ...
            <section className={styles.detailsSection}>
              <div className={styles.detailsColumn}>
                <div><strong>Date of Birth</strong><br />{selectedCandidate.dob}</div>
                <div><strong>Nationality</strong><br />{selectedCandidate.nationality}</div>
                <div><strong>Marital Status</strong><br />{selectedCandidate.maritalStatus}</div>
                <div><strong>Gender</strong><br />{selectedCandidate.gender}</div>
                <div><strong>Experience</strong><br />{selectedCandidate.experience}</div>
                <div><strong>Educations</strong><br />{selectedCandidate.education}</div>
              </div>
              ...
              <div className={styles.contactInfo}>
                ...
                <p><strong>Website:</strong> {selectedCandidate.website}</p>
                <p><strong>Location:</strong> {selectedCandidate.location}</p>
                <p><strong>Phone:</strong> {selectedCandidate.phone}</p>
                <p><strong>Secondary Phone:</strong> {selectedCandidate.secondaryPhone}</p>
