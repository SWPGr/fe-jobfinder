            ...
            <aside className={cx('sidebar')}>
                ...
                <ul className={cx('nav')}>
                    {[
                        ...
                        <li key={item} className={cx('nav-item', { active: item === 'Overview' })}>
                            {item}
                        </li>
                    ))}
                    ...
                    <div className={cx('job-list')}>
                        ...
                        {jobsData.map((job, index) => (
                            <div key={job.title} className={cx('job-row')}>
                                ...
                                <Button size="xs" color="blue" onClick={() => alert('view')}>
                                    {' '}
                                    View Applications
                                </Button>
                                <div
                                ...
                                >
                                    ...
                                    {openIndex === index && (
                                        <div className={cx('dropdown')}>
                                            <div>
                                                <IconStar size={16} /> Promote Job
                                            </div>
                                            <div>
                                                <IconEye size={16} /> View Detail
                                            </div>
                                            <div>
                                                <IconClock size={16} /> Mark as expired
                                            </div>
                                        </div>
                                    )}
                                </div>
